...
SECRET_KEY = '2metxef#f-2qnhwu0itvjy&amp;7nd8k*b^y_8u749zmt(&amp;_voawia'
...
SQLALCHEMY_DATABASE_URI = 'postgres://anthill_market@/anthill_market'

LOCATION = 'http://localhost:9627'
BROKER = 'amqp://guest:guest@localhost:5672'

# ROUTES_CONF = 'market.routes'

TEMPLATE_PATH = os.path.join(BASE_DIR, 'ui', 'templates')
LOCALE_PATH = os.path.join(BASE_DIR, 'locale')

CACHES["default"]["LOCATION"] = "redis://localhost:6379/37"
CACHES["default"]["KEY_PREFIX"] = "market.anthill"
...
# SERVICE_CLASS = 'market.services.Service'

# UI_MODULE = 'market.ui'

EMAIL_SUBJECT_PREFIX = '[Anthill: market] '
...
LOGGING = {
    ...
    'handlers': {
        ...
        'anthill.server': {
            ...
            'filename': '/var/log/anthill/market.log',
            'formatter': 'anthill.server',
...
GRAPHENE = {
    'SCHEMA': 'market.api.v1.public.schema',
    'MIDDLEWARE': ()
}
